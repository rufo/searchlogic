This version fixes up searchlogic v1 to work with rails_xss, for use in a Rails 2.3 application I'm working on cleaning up and transitioning to Rails 3. Not reccomended, unless you're in the same boat.
